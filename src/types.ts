/**
 *  Interface type for response from "Enhanced Transactions API" from Helius.
 *  Returns an array of enriched transactions.
 */
interface EnrichedTransactionReponse {
  description: string;
  type: string;
  source: string;
  fee: number;
...
/**
 *  Interface type for response from Pump.fun coin information.
 */
...
/**
 *  Interface for DexScreener order
 */
...
// Update to reflect an array of transactions
export type EnrichedTransactionReponseArray = EnrichedTransactionReponse[];
